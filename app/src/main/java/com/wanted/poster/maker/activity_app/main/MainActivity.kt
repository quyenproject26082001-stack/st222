package com.wanted.poster.maker.activity_app.main
...
import com.wanted.poster.maker.core.utils.key.ValueKey
import com.wanted.poster.maker.core.utils.state.RateState
import com.wanted.poster.maker.databinding.ActivityHomeBinding
import com.wanted.poster.maker.activity_app.SettingsActivity
import com.wanted.poster.maker.activity_app.bountyfilter.BountyFilterActivity
import com.wanted.poster.maker.activity_app.mycreation.MyCreationActivity
import com.wanted.poster.maker.activity_app.posterwanted.PosterWantedTemplateActivity
        ...
        binding.apply {
            ...
            btnCreate.setOnSingleClick {
                showInterAll {
                    ...
                    startIntentRightToLeft(com.wanted.poster.maker.activity_app.makescreen.MakeScreenActivity::class.java)
                }
            ...
            btnOldWest.setOnSingleClick {
                showInterAll {
                    startIntentRightToLeft(com.wanted.poster.maker.activity_app.oldwest.OldWestActivity::class.java)
                }
            }
            //quyen
        }
