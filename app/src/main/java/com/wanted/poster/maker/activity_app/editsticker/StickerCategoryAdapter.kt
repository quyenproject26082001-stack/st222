package com.wanted.poster.maker.activity_app.editsticker
...
import com.wanted.poster.maker.databinding.ItemStickerCategoryBinding
...
class StickerCategoryAdapter(
    ...
    inner class CategoryViewHolder(
        ...
        fun bind(item: StickerCategory, isSelected: Boolean) {
            ...
            if (isSelected) {
                binding.imgCategoryThumb.setBackgroundResource(com.wanted.poster.maker.R.drawable.bg_cateris_selected)
            } else {
                binding.imgCategoryThumb.setBackgroundResource(com.wanted.poster.maker.R.drawable.bg_item_category)
            }
