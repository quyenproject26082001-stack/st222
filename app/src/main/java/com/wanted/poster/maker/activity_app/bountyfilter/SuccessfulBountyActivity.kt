package com.wanted.poster.maker.activity_app.bountyfilter
...
import com.wanted.poster.maker.core.extensions.shareImagesPaths
...
import com.wanted.poster.maker.core.helper.BitmapHelper
import com.wanted.poster.maker.core.helper.MediaHelper
import com.wanted.poster.maker.core.helper.PermissionHelper
import com.wanted.poster.maker.core.helper.SoundHelper
import com.wanted.poster.maker.core.utils.state.HandleState
import com.wanted.poster.maker.core.viewmodel.PosterEditorSharedViewModel
import com.wanted.poster.maker.databinding.SuccessfullBountyBinding
...
class SuccessfulBountyActivity : BaseActivity<SuccessfullBountyBinding>() {
            ...
            try {
                ...
                withContext(Dispatchers.Main) {
                    val intent = Intent(this@SuccessfulBountyActivity,
                        com.wanted.poster.maker.activity_app.editsticker.EditStickerActivity::class.java)
    ...
    private fun goToMyFilter() {
        val intent = Intent(this, com.wanted.poster.maker.activity_app.mycreation.MyCreationActivity::class.java)
